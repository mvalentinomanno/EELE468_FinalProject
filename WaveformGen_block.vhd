-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\chorus_try10sin\WaveformGen_block.vhd
...
-- Source Path: chorus_try10sin/dataplane/double_chorus/NCO HDL Optimized2/WaveformGen
-- Hierarchy Level: 3
-- 
...
BEGIN
  u_SineWave_inst : LookUpTableGen_block
    PORT MAP( clk => clk,
              reset => reset,
